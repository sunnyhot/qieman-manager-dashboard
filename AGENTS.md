...
### macos-app/ — SwiftUI 原生 App（97 个 Swift 文件，约 27714 行）
...
#### Core/ 核心逻辑（51 个 Swift 文件，约 14560 行）
| 文件 | 行数 | 职责 |
|---|---|---|
...
| `Tests/` | 15 个 Swift 文件 / 约 1360 行 | XCTest：更新、窗口 zoom、排序、简报、洞察、诊断、对比、提醒、收益归因、计划模拟、月报、策略雷达 |
...
- 新增功能优先补 XCTest；当前基线是 `swift test` 40 tests / 0 failures
